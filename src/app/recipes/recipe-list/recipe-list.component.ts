...
export class RecipeListComponent implements OnInit {
  ...
  recipes: Recipe[] = [
    ...
    new Recipe('Sausages', 'With fries', 'https://res.cloudinary.com/hellofresh/image/upload/f_auto,fl_lossy,h_436,q_auto/v1/hellofresh_s3/image/5a961107ae08b5296f1ab7b2-3641081a.jpg')
  ];
